...
# 2. Initialize W&B Run [cite: 197]
wandb.init(
    project='mlops-assignment3',
    name='run-v1', # Change this to run-v2 for your second experiment [cite: 197]
    config={
        'model': 'distilbert-base-uncased',
        'epochs': 3,
        'batch_size': 16,
        'learning_rate': 3e-5, # Change this hyperparameter in run 2 [cite: 197, 200]
        'version': 'v1',
        'platform': 'Kaggle',
    }
)
...
# 3. Define Metrics & Train [cite: 199]
